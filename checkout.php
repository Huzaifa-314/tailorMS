...
$post_data['cus_name'] = isset($_SESSION['username']) ? $_SESSION['username'] : $_COOKIE['username'];
...
$post_data['cus_phone'] = isset($_POST['contact_number']) ? $_POST['contact_number'] : "";
...
# First, save the input data into local database table `payment`
