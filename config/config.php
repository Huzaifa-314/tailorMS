...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost/tailor'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'hospi663d2655aa23c'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'hospi663d2655aa23c@ssl'); // your store password.
}
