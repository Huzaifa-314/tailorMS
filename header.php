...
if (!is_admin() && !is_employee()) {
  ...
  redirect('signout.php?error=You are not admin or employee');
}
...
<head>
  ...
  <title>Clothing Customiation Management System</title>
...
<body>
  ...
  <section>
    ...
    <div class="leftpanel">
      ...
      <div class="logopanel">
        <h1>Clothing Customiation Management System</h1>
      </div><!-- logopanel -->
      ...
      <div class="leftpanelinner">
        ...
        <ul class="nav nav-pills nav-stacked nav-bracket">
          ...
          <li><a href="categoryview.php"><i class="fa fa-user"></i><span>View/Edit Cateogry</span></a></li>
